...
import { ArrowLeft, MessageCircle, Truck, ShieldCheck, Loader2 } from "lucide-react";
...
export default function ProductDetailPage() {
  ...
  if (isLoading) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin w-10 h-10 text-brand-green" /></div>;
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col pt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 w-full mb-20">
        <Link href="/katalog" className="inline-flex items-center gap-2 text-gray-500 hover:text-brand-green mb-6 transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <div className="prose prose-sm text-gray-600 mb-8">
                <h3 className="font-bold text-gray-900 text-lg mb-2">Deskripsi</h3>
               ...
               <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div className="text-xs">
                    <p className="font-bold text-gray-900">Pengiriman Cepat</p>
                    <p className="text-gray-500">Aman sampai tujuan</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                  <ShieldCheck className="text-brand-green" />
                  <div className="text-xs">
                    <p className="font-bold text-gray-900">Garansi Hidup</p>
                    <p className="text-gray-500">Ganti baru jika mati</p>
                  </div>
                </div>
              </div>
