        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 text-center">
          <div className="p-6 rounded-2xl bg-green-50 border border-green-100">
            ...
            <p className="text-gray-600 text-sm">
              Tanaman dirawat oleh ahlinya, memastikan Anda mendapatkan yang
              terbaik.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-green-50 border border-green-100">
          ...
          <div className="p-6 rounded-2xl bg-green-50 border border-green-100">
            ...
            <p className="text-gray-600 text-sm">
              Tim kami siap membantu Anda menemukan tanaman yang sempurna.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link
              href="/katalog"
              className="hidden md:flex items-center gap-2 text-brand-green font-semibold hover:underline"
            >
          ...
          {isLoading ? (
            ...
            <div className="text-center py-10 text-gray-500">
              Tidak ada produk unggulan untuk ditampilkan.
            </div>
          )}
          ...
          <div className="text-center md:hidden">
            <Link
              href="/katalog"
              className="inline-flex items-center gap-2 bg-white border border-gray-300 px-6 py-3 rounded-full font-semibold text-gray-700"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Bingung Cara Merawat Tanaman?
            </h2>
            <p className="text-green-100 text-lg mb-8">
              Jangan khawatir tanaman mati. Gunakan fitur AI Chatbot kami untuk
              mendapatkan panduan perawatan instan.
            </p>
            <Link
              href="/edukasi"
              className="bg-white text-brand-green px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition inline-flex items-center gap-2"
            >
          ...
          <div className="relative h-80 bg-white/10 rounded-2xl backdrop-blur-sm p-6 border border-white/20 flex flex-col justify-center">
            ...
            <div className="bg-white text-gray-800 self-start p-3 rounded-2xl rounded-bl-none max-w-[90%] text-sm shadow-lg">
              <p className="font-bold text-brand-green mb-1 text-xs">
                Mawar AI:
              </p>
