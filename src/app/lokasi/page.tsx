...
export default function LokasiPage() {
    ...
    const navigationUrl = `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(displayData.address_detail)}`;
        ...
        <main className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <section className="bg-brand-green text-white pt-24 pb-16 md:pt-24 md:pb-20 rounded-b-4xl md:rounded-b-[3rem] shadow-sm relative z-0 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-green-100">Semua data diambil secara dinamis dari pengaturan admin.</p>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 w-full grow">
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 bg-white p-8 rounded-2xl shadow-lg h-fit border border-gray-100">
                        <h3 className="text-2xl font-bold mb-6 border-b pb-4">Informasi Kontak</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm mt-1">WA: {displayData.whatsapp_number}</p>
                                    <p className="text-gray-500 text-xs mt-1">Email: {displayData.business_email}</p>
                                </div>
                            </div>
